...
from nyan.document import (read_annotated_documents_mongo, read_documents_file,
...
class Daemon:
    ...
    def __call__(
        ...
        for cluster in new_clusters:
            self.send_cluster(cluster, cluster.annotation_doc.issue, posted_clusters, posted_clusters_path, mongo_config_path)
